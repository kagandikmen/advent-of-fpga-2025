...
src/
└── dayXX/
    └── dayXX.ml        # My solution for the puzzle of the day XX
test/
└── dayXX/
...
To run the tests, you must have OCaml and opam on your machine. Refer to [OCaml's official installation guide](https://ocaml.org/docs/installing-ocaml) to install them. After the installation, use [this guide](https://ceramichacker.com/blog/5-4x-ocaml-setup-hardcaml-basics-and-project-plan) to set your machine up and install Hardcaml.
