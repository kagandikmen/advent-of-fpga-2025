(*
 *
 * AoF - Testbench for the Solution of Day 8
 * Created:     2025-12-31
 * Modified:    2026-01-02
 * Author:      Kagan Dikmen
 *
...
let%expect_test "day08_test" =
  ...
  let part_1, part_2, is_done, debug_output = Day08.create_day08_logic
    ~clock
    ~clear
    ~cycles_per_bit
    uart_rx_value
  ...
  sim_driver.wait_until_done ~step:50 ~max_steps:200_000_000_000;
